      ...
      Category(
          ...
          subCategories: [
            SubCategory(
                ...
                parts: [
                  CategoryPart(
                      name: 'Buildings', imgName: 'japan1', isSelected: false),
                  CategoryPart(
                      name: 'River', imgName: 'japan2', isSelected: false),
                  CategoryPart(
                      name: 'Muscle man', imgName: 'japan4', isSelected: false),
                  CategoryPart(
                      name: 'Totoro', imgName: 'japan5', isSelected: false),
                  CategoryPart(
                      name: 'Fukuoka', imgName: 'japan6', isSelected: false),
                ]),
            SubCategory(
